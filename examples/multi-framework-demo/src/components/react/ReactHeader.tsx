  ...
  return (
    <article className="counter-card" style={{ '--accent': '#61dafb' } as React.CSSProperties}>
      <div>
        ...
        <div className="card-title">Hook subscriber</div>
        <p className="card-copy">Uses the React adapter hook and re-renders from the shared store.</p>
      </div>

      <div>
        <div className="count-value" data-counter="react">{state.count}</div>
        <div className="last-update">Last writer: {state.framework}</div>
